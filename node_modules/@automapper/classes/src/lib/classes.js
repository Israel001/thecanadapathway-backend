...
const classes = (errorHandler) => {
    ...
    return {
        ...
        initializeMapping(source, destination, options) {
            ...
            return core_1.createInitialMapping(sourceInstance, destinationInstance, sourceNestedConstructible, destinationNestedConstructible, (mapping) => {
                ...
                isDerivedSourcePathOnSource: utils_1.isDerivedSourcePathOnSourceClasses(sourceProto),
            });
        },
