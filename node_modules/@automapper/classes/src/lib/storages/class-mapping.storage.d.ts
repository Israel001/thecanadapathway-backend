 ...
 * @private
 */
export declare class ClassMappingStorage implements MappingStorage<Constructible> {
    private storage;
    get(source: Constructible, destination: Constructible): Mapping | undefined;
    set(source: Constructible, destination: Constructible, mapping: Mapping): void;
