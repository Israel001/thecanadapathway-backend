...
function createMapper({ name, pluginInitializer, namingConventions, errorHandler: customErrorHandler, }) {
    ...
    return {
        ...
        addTypeConverter(source, destination, converter) {
            ...
            typeConverters.set(source, new WeakMap([
        ...
        createMap(source, destination, options = {}) {
            ...
            if (mapping) {
                ...
                apply_type_converters_util_1.applyTypeConverters(mapping, typeConverters);
            }
            // return the FluentFunction for chaining
            return create_map_fluent_function_util_1.createMapFluentFunction(mapping);
        },
        ...
        map(sourceObj, destination, source, destinationObjOrOptions, options) {
            ...
            if ((destinationObjOrOptions &&
                ...
                const result = map_1.mapReturn(sourceInstance, mapping, destinationObjOrOptions, this, errorHandler);
                if (postMap) {
                    return postMap.apply(plugin, [destination, result]);
                }
                return result;
            }
            map_1.mapMutate(sourceInstance, mapping, options || {}, this, errorHandler, destinationObjOrOptions);
            if (postMap) {
        ...
        mapArray(sourceArr, destination, source, options) {
            ...
            return map_1.mapArray(sourceArr, destination, source, options || {}, this, errorHandler);
        },
