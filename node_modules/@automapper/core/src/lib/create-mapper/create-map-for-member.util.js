...
function createMapForMember(mapping, selector, [preCondOrMapMemberFn, mapMemberFn]) {
    ...
    const memberPath = get_member_path_util_1.getMemberPath(selector);
    ...
    if (mapMemberFn[0 /* type */] === 4 /* MapWith */ &&
        ...
        sourcePath = get_member_path_util_1.getMemberPath(mapMemberFn[2 /* misc */]);
    }
    ...
    const existProp = mapping[2 /* properties */].find(([propName]) => utils_1.isSamePath(propName, memberPath));
    // if exists, overrides
    if (existProp != null) {
